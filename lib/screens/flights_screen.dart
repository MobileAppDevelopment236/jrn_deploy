...
class FlightsScreen extends StatelessWidget {
  ...
  final String googleTravelUrl = 'https://www.google.com/travel/flights';
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            Text(
              'Search for domestic and international flights through Google Travel with real-time prices and best deals.',
              style: GoogleFonts.inter(
            ...
            _buildFeatureRow('Domestic & international flights'),
            _buildFeatureRow('Flexible date options'),
            _buildFeatureRow('Multiple airline choices'),
          ],
        ),
      ),
    );
        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              Expanded(
                child: Text(
                  'You will be redirected to Google Travel website to search and book flights',
                  style: GoogleFonts.inter(
                    fontSize: 13,
                    color: Colors.grey[700],
                  ),
      ...
      child: ElevatedButton(
        ...
        child: Row(
          ...
          children: [
            ...
            const SizedBox(width: 12),
            Text(
              'Search Flights on Google Travel',
              style: GoogleFonts.inter(
                fontWeight: FontWeight.w600,
                fontSize: 16,
              ),
